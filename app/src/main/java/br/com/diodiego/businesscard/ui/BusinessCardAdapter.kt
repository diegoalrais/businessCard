...
import br.com.diodiego.businesscard.databinding.ItemBusinessCardBinding
...
class BusinessCardAdapter :
    ...
    class DiffCallBack: DiffUtil.ItemCallback<BusinessCard>() {
        ...
        override fun areItemsTheSame(oldItem: BusinessCard, newItem: BusinessCard) = oldItem.id == newItem.id
